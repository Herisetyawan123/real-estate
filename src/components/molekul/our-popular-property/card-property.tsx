   ...
   return (
      <div className='bg-white rounded-xl overflow-hidden hover:shadow-xl transition-all duration-500'>
         ...
         <div className="body mx-5 py-5 border-b">
            <h3 className='text-blue font-bold text-xl'>$50,200,0</h3>
            <p>The Bismillah Apartment</p>
         </div>
         <div className="footer p-5">
            <IconLabel Icon={CiLocationOn} label='Noakhali, Bangladesh' />
            <div className="flex w-full justify-between mt-5">
               <IconLabel Icon={BiBed} label='4 Bed' />
               <IconLabel Icon={BiBath} label='4 Bath' />
               <IconLabel Icon={BiCar} label='1 Parking' />
            </div>
         </div>
      </div>
   )
